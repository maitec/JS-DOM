...
.then(data => {
    ...
    function clickEnCategoriaOViewAll(){
        ...
        nuevoContenedor.innerHTML = `<div class="titulo"> <h2>Popular Movies</h2> <p>${totalDeResultadosFetch} results</p> </div>`;
        const divMovies = document.createElement("div");
        divMovies.classList.add("movies");
